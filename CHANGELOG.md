...
- Added manual glossary reload, actionable validation errors, and empty-glossary and no-match states.
- Kept glossary data private and local, with support for macOS and Windows.
